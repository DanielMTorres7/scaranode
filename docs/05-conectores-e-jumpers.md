...
|---|---|---|---|
| **J5** 24 V | esquerda: **+24 V** | +24 V da fonte (depois do relé/fusível) | Passa pelo D1; invertido, nada liga |
| | direita: **GND** | 0 V da fonte | Mesmo GND do USB: fonte e host no mesmo terra |
| **J6** MOTOR | de cima para baixo: **2B, 2A, 1A, 1B** | bobinas do NEMA 17 | Os dois de cima são uma bobina, os dois de baixo a outra. Trocar um par inverte o sentido (ou use `!` no `dir_pin`). |
