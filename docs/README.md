...
| **Placa** | 76 × 64 mm · FR-4 1,6 mm · cobre só na face de baixo (B.Cu) |
| **Ferramenta** | KiCad 10.0.6 · placa gerada por ferramenta própria em Python; fonte editável: `hardware/ScaraNode.kicad_pcb` |
| **Estado** | Validada: 126 pinos conferidos contra o esquemático (ERC 0, paridade 0), DRC de cobre sem erro e 0 ligações faltando; onde os courtyards se sobrepõem, corpos a ≥ 0,10 mm (menor 0,30 mm); vão mínimo 0,60 mm, anel mínimo 0,40 mm |
...
| 5 | [Conectores, pinagem e jumpers](05-conectores-e-jumpers.md) | O que ligar em cada pino, ZM, JU |
...
**PDF:** [`ScaraNode-Manual-v17.pdf`](ScaraNode-Manual-v17.pdf), gerado destes mesmos arquivos. Esquemático: [`ScaraNode-Esquematico-v17.pdf`](ScaraNode-Esquematico-v17.pdf).
